...
<body>
 ...
 <?php else : ?>
        ...
        <?php
                ...
                $limite=0;
                if (($tipo_busqueda == "descripcion" ) && (($_SESSION['idusuario'] == "ADMIN")|| ($_SESSION['idusuario'] == "ASERPA1")))
                {
                    if ($_SESSION['idusuario'] == "ADMIN"){
                    ...
                    */
                    ...
                    $sql = $con->prepare("SELECT * FROM inventario WHERE $where AND Tipo <> 'use' LIMIT $limite");
                    $sql->execute($params);
