...
// ===============================================Paolo
// Funcion que consulta si hay un descuento para la referencia y retorna la info
...
function renderDescuentoBox($descuentoInfo) {
    // Si no hay info de descuento, no muestra nada
    ...
    return $fecha; // si no es una fecha valida
}
...
<div style="display: flex; justify-content: center; margin: 0px 0 0px 0;">
  <div id="descuento-box" style="
    max-width: 700px; /* Ampliando un poco mas el tamaño del cuadro */
    width: 100%;
    padding: 15px 25px; /* Aumento mas el padding para que haya mas espacio */
    font-size: 15px; /* Aumento ligeramente el tamaño de la fuente */
    display: flex;
    align-items: center;
    ...
    <div class="container">
       ...
       <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <div class="form-group">
                <label for="tipo_busqueda">Buscar por Referencia:</label>
                <div>
                    <input type="radio" id="referencia" name="tipo_busqueda" value="referencia" checked> 
...
<?php else : ?>
        ...
        <?php
                ...
                if ($tipo_busqueda == "descripcion")
                {
                    ...
                    $sql = $con->prepare("SELECT * FROM inventario WHERE descripcion LIKE :descripcion LIMIT 20");
